...
c.JupyterHub.authenticator_class = 'jupyterhub.auth.PAMAuthenticator'#LocalGitHubOAuthenticator #'jupyterhub.auth.PAMAuthenticator' # LocalGitHubOAuthenticator
...
#  differ.
#c.JupyterHub.hub_ip = 'lwivs48.gm.fh-koeln.de'
...
#MTEDIT c.JupyterHub.ssl_cert = '/etc/jupyterhub/mycert.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
#MTEDIT c.JupyterHub.ssl_key = '/etc/jupyterhub/mykey.key'
...
c.Authenticator.admin_users = {'thill'}
