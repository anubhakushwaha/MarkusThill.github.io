...
Demo
----------------
[JQuery lightSlider demo](https://sachinchoolur.github.io/lightslider/)
...
You can Install lightslider using the [Bower](https://bower.io) package manager.
...
You can also find lightslider on [npm](https://npmjs.org).
